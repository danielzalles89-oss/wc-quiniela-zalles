...
const GROUP_MATCHES = [
  ...
  { id:"G8",  date:"Jun 14", kickoff:"2026-06-14T19:00:00Z", home:"Australia",     away:"Turkey",         group:"D" },
  { id:"G9",  date:"Jun 14", kickoff:"2026-06-14T22:00:00Z", home:"Germany",       away:"Curaçao",        group:"E" },
  { id:"G10", date:"Jun 14", kickoff:"2026-06-15T01:00:00Z", home:"Netherlands",   away:"Japan",          group:"F" },
  { id:"G11", date:"Jun 14", kickoff:"2026-06-14T16:00:00Z", home:"Ivory Coast",   away:"Ecuador",        group:"E" },
  { id:"G12", date:"Jun 14", kickoff:"2026-06-15T04:00:00Z", home:"Sweden",        away:"Tunisia",        group:"F" },
  { id:"G13", date:"Jun 15", kickoff:"2026-06-15T16:00:00Z", home:"Spain",         away:"Cape Verde",     group:"H" },
  { id:"G14", date:"Jun 15", kickoff:"2026-06-15T19:00:00Z", home:"Belgium",       away:"Egypt",          group:"G" },
  { id:"G15", date:"Jun 15", kickoff:"2026-06-15T22:00:00Z", home:"Saudi Arabia",  away:"Uruguay",        group:"H" },
  { id:"G16", date:"Jun 15", kickoff:"2026-06-16T01:00:00Z", home:"Iran",          away:"New Zealand",    group:"G" },
  { id:"G17", date:"Jun 16", kickoff:"2026-06-16T16:00:00Z", home:"France",        away:"Senegal",        group:"I" },
  { id:"G18", date:"Jun 16", kickoff:"2026-06-16T19:00:00Z", home:"Iraq",          away:"Norway",         group:"I" },
  { id:"G19", date:"Jun 16", kickoff:"2026-06-16T22:00:00Z", home:"Argentina",     away:"Algeria",        group:"J" },
  { id:"G20", date:"Jun 16", kickoff:"2026-06-17T01:00:00Z", home:"Austria",       away:"Jordan",         group:"J" },
  { id:"G21", date:"Jun 17", kickoff:"2026-06-17T16:00:00Z", home:"Portugal",      away:"DR Congo",       group:"K" },
  { id:"G22", date:"Jun 17", kickoff:"2026-06-17T19:00:00Z", home:"Uzbekistan",    away:"Colombia",       group:"K" },
  ...
  { id:"G25", date:"Jun 18", kickoff:"2026-06-18T16:00:00Z", home:"Czechia",       away:"South Africa",   group:"A" },
  { id:"G26", date:"Jun 18", kickoff:"2026-06-18T19:00:00Z", home:"Switzerland",   away:"Bosnia & Herz.", group:"B" },
  { id:"G27", date:"Jun 18", kickoff:"2026-06-18T22:00:00Z", home:"Canada",        away:"Qatar",          group:"B" },
  { id:"G28", date:"Jun 18", kickoff:"2026-06-19T01:00:00Z", home:"Mexico",        away:"South Korea",    group:"A" },
  { id:"G29", date:"Jun 19", kickoff:"2026-06-19T19:00:00Z", home:"USA",           away:"Australia",      group:"D" },
  { id:"G30", date:"Jun 19", kickoff:"2026-06-19T22:00:00Z", home:"Scotland",      away:"Morocco",        group:"C" },
  { id:"G31", date:"Jun 19", kickoff:"2026-06-20T01:00:00Z", home:"Brazil",        away:"Haiti",          group:"C" },
  { id:"G32", date:"Jun 19", kickoff:"2026-06-20T04:00:00Z", home:"Turkey",        away:"Paraguay",       group:"D" },
  { id:"G33", date:"Jun 20", kickoff:"2026-06-20T17:00:00Z", home:"Netherlands",   away:"Sweden",         group:"F" },
  { id:"G34", date:"Jun 20", kickoff:"2026-06-20T20:00:00Z", home:"Germany",       away:"Ivory Coast",    group:"E" },
  { id:"G35", date:"Jun 20", kickoff:"2026-06-21T00:00:00Z", home:"Ecuador",       away:"Curaçao",        group:"E" },
  { id:"G36", date:"Jun 20", kickoff:"2026-06-21T04:00:00Z", home:"Tunisia",       away:"Japan",          group:"F" },
  { id:"G37", date:"Jun 21", kickoff:"2026-06-21T16:00:00Z", home:"Spain",         away:"Saudi Arabia",   group:"H" },
  { id:"G38", date:"Jun 21", kickoff:"2026-06-21T19:00:00Z", home:"Belgium",       away:"Iran",           group:"G" },
  { id:"G39", date:"Jun 21", kickoff:"2026-06-21T22:00:00Z", home:"Uruguay",       away:"Cape Verde",     group:"H" },
  { id:"G40", date:"Jun 21", kickoff:"2026-06-22T01:00:00Z", home:"New Zealand",   away:"Egypt",          group:"G" },
  { id:"G41", date:"Jun 22", kickoff:"2026-06-22T17:00:00Z", home:"Argentina",     away:"Austria",        group:"J" },
  { id:"G42", date:"Jun 22", kickoff:"2026-06-22T21:00:00Z", home:"France",        away:"Iraq",           group:"I" },
  { id:"G43", date:"Jun 22", kickoff:"2026-06-23T00:00:00Z", home:"Norway",        away:"Senegal",        group:"I" },
  { id:"G44", date:"Jun 22", kickoff:"2026-06-23T03:00:00Z", home:"Jordan",        away:"Algeria",        group:"J" },
  { id:"G45", date:"Jun 23", kickoff:"2026-06-23T17:00:00Z", home:"Portugal",      away:"Uzbekistan",     group:"K" },
  { id:"G46", date:"Jun 23", kickoff:"2026-06-23T20:00:00Z", home:"England",       away:"Ghana",          group:"L" },
  { id:"G47", date:"Jun 23", kickoff:"2026-06-23T23:00:00Z", home:"Panama",        away:"Croatia",        group:"L" },
  { id:"G48", date:"Jun 23", kickoff:"2026-06-24T02:00:00Z", home:"Colombia",      away:"DR Congo",       group:"K" },
  { id:"G49", date:"Jun 24", kickoff:"2026-06-24T19:00:00Z", home:"Switzerland",   away:"Canada",         group:"B" },
  { id:"G50", date:"Jun 24", kickoff:"2026-06-24T19:00:00Z", home:"Bosnia & Herz.",away:"Qatar",          group:"B" },
  { id:"G51", date:"Jun 24", kickoff:"2026-06-24T22:00:00Z", home:"Scotland",      away:"Brazil",         group:"C" },
  { id:"G52", date:"Jun 24", kickoff:"2026-06-24T22:00:00Z", home:"Morocco",       away:"Haiti",          group:"C" },
  { id:"G53", date:"Jun 24", kickoff:"2026-06-25T01:00:00Z", home:"South Africa",  away:"South Korea",    group:"A" },
  { id:"G54", date:"Jun 24", kickoff:"2026-06-25T01:00:00Z", home:"Czechia",       away:"Mexico",         group:"A" },
  ...
  { id:"G63", date:"Jun 26", kickoff:"2026-06-27T00:00:00Z", home:"Cape Verde",    away:"Saudi Arabia",   group:"H" },
  { id:"G64", date:"Jun 26", kickoff:"2026-06-27T00:00:00Z", home:"Uruguay",       away:"Spain",          group:"H" },
  { id:"G65", date:"Jun 26", kickoff:"2026-06-27T03:00:00Z", home:"Egypt",         away:"Iran",           group:"G" },
  { id:"G66", date:"Jun 26", kickoff:"2026-06-27T03:00:00Z", home:"New Zealand",   away:"Belgium",        group:"G" },
  ...
  { id:"G71", date:"Jun 27", kickoff:"2026-06-28T02:00:00Z", home:"Algeria",       away:"Austria",        group:"J" },
  { id:"G72", date:"Jun 27", kickoff:"2026-06-28T02:00:00Z", home:"Jordan",        away:"Argentina",      group:"J" },
];

const KNOCKOUT_SLOTS = [
  ...Array.from({length:16},(_,i)=>({ id:`R32-${String(i+1).padStart(2,"0")}`, stage:"r32", home:"TBD", away:"TBD", date:"Jun 28 – Jul 3", kickoff:"2026-06-28T19:00:00Z" })),
...
export default function App() {
  ...
  async function loadLeaderboard(){
    ...
    snap.forEach(d=>{
      ...
      users.push({uid:d.id,name:p._displayName||d.id,photo:p._photoURL||null,total});
    });
  ...
  function exportCSV() {
    ...
    const ORIGINAL_MATCHES = [
      {id:"G1",date:"Jun 11",home:"Mexico",away:"South Africa"},
      {id:"G2",date:"Jun 11",home:"South Korea",away:"Czechia"},
      {id:"G3",date:"Jun 12",home:"Canada",away:"Bosnia & Herz."},
      {id:"G4",date:"Jun 12",home:"USA",away:"Paraguay"},
      {id:"G5",date:"Jun 13",home:"Qatar",away:"Switzerland"},
      {id:"G6",date:"Jun 13",home:"Brazil",away:"Morocco"},
      {id:"G7",date:"Jun 13",home:"Haiti",away:"Scotland"},
      {id:"G8",date:"Jun 13",home:"Australia",away:"Turkey"},
      {id:"G9",date:"Jun 14",home:"Germany",away:"Curaçao"},
      {id:"G10",date:"Jun 14",home:"Netherlands",away:"Japan"},
      {id:"G11",date:"Jun 14",home:"Ivory Coast",away:"Ecuador"},
      {id:"G12",date:"Jun 15",home:"Sweden",away:"Tunisia"},
      {id:"G13",date:"Jun 15",home:"Spain",away:"Cape Verde"},
      {id:"G14",date:"Jun 15",home:"Belgium",away:"Egypt"},
      {id:"G15",date:"Jun 15",home:"Saudi Arabia",away:"Uruguay"},
      {id:"G16",date:"Jun 16",home:"Iran",away:"New Zealand"},
      {id:"G17",date:"Jun 16",home:"France",away:"Senegal"},
      {id:"G18",date:"Jun 16",home:"Iraq",away:"Norway"},
      {id:"G19",date:"Jun 17",home:"Argentina",away:"Algeria"},
      {id:"G20",date:"Jun 17",home:"Austria",away:"Jordan"},
      {id:"G21",date:"Jun 17",home:"Portugal",away:"DR Congo"},
      {id:"G22",date:"Jun 17",home:"Uzbekistan",away:"Colombia"},
      {id:"G23",date:"Jun 17",home:"England",away:"Panama"},
      {id:"G24",date:"Jun 18",home:"Ghana",away:"Croatia"},
      {id:"G25",date:"Jun 18",home:"Mexico",away:"South Korea"},
      {id:"G26",date:"Jun 18",home:"Czechia",away:"South Africa"},
      {id:"G27",date:"Jun 18",home:"Switzerland",away:"Bosnia & Herz."},
      {id:"G28",date:"Jun 19",home:"Canada",away:"Qatar"},
      {id:"G29",date:"Jun 19",home:"USA",away:"Australia"},
      {id:"G30",date:"Jun 19",home:"Turkey",away:"Paraguay"},
      {id:"G31",date:"Jun 19",home:"Morocco",away:"Haiti"},
      {id:"G32",date:"Jun 20",home:"Brazil",away:"Scotland"},
      {id:"G33",date:"Jun 20",home:"Germany",away:"Ivory Coast"},
      {id:"G34",date:"Jun 20",home:"Ecuador",away:"Curaçao"},
      {id:"G35",date:"Jun 20",home:"Netherlands",away:"Sweden"},
      {id:"G36",date:"Jun 21",home:"Japan",away:"Tunisia"},
      {id:"G37",date:"Jun 21",home:"Belgium",away:"Iran"},
      {id:"G38",date:"Jun 21",home:"New Zealand",away:"Egypt"},
      {id:"G39",date:"Jun 21",home:"Spain",away:"Saudi Arabia"},
      {id:"G40",date:"Jun 22",home:"Uruguay",away:"Cape Verde"},
      {id:"G41",date:"Jun 22",home:"Argentina",away:"Austria"},
      {id:"G42",date:"Jun 22",home:"Jordan",away:"Algeria"},
      {id:"G43",date:"Jun 22",home:"France",away:"Iraq"},
      {id:"G44",date:"Jun 23",home:"Norway",away:"Senegal"},
      {id:"G45",date:"Jun 23",home:"Portugal",away:"Uzbekistan"},
      {id:"G46",date:"Jun 23",home:"Colombia",away:"DR Congo"},
      {id:"G47",date:"Jun 23",home:"England",away:"Ghana"},
      {id:"G48",date:"Jun 24",home:"Croatia",away:"Panama"},
      {id:"G49",date:"Jun 24",home:"South Korea",away:"South Africa"},
      {id:"G50",date:"Jun 24",home:"Mexico",away:"Czechia"},
      {id:"G51",date:"Jun 24",home:"Bosnia & Herz.",away:"Qatar"},
      {id:"G52",date:"Jun 25",home:"Switzerland",away:"Canada"},
      {id:"G53",date:"Jun 25",home:"Scotland",away:"Morocco"},
      {id:"G54",date:"Jun 25",home:"Haiti",away:"Brazil"},
      {id:"G55",date:"Jun 25",home:"Paraguay",away:"Australia"},
      {id:"G56",date:"Jun 26",home:"Turkey",away:"USA"},
      {id:"G57",date:"Jun 26",home:"Curaçao",away:"Germany"},
      {id:"G58",date:"Jun 26",home:"Ecuador",away:"Ivory Coast"},
      {id:"G59",date:"Jun 26",home:"Tunisia",away:"Netherlands"},
      {id:"G60",date:"Jun 26",home:"Sweden",away:"Japan"},
      {id:"G61",date:"Jun 26",home:"Norway",away:"France"},
      {id:"G62",date:"Jun 26",home:"Senegal",away:"Iraq"},
      {id:"G63",date:"Jun 26",home:"Cape Verde",away:"Saudi Arabia"},
      {id:"G64",date:"Jun 26",home:"Uruguay",away:"Spain"},
      {id:"G65",date:"Jun 27",home:"Egypt",away:"Iran"},
      {id:"G66",date:"Jun 27",home:"New Zealand",away:"Belgium"},
      {id:"G67",date:"Jun 27",home:"Panama",away:"England"},
      {id:"G68",date:"Jun 27",home:"Croatia",away:"Ghana"},
      {id:"G69",date:"Jun 27",home:"Colombia",away:"Portugal"},
      {id:"G70",date:"Jun 27",home:"DR Congo",away:"Uzbekistan"},
      {id:"G71",date:"Jun 28",home:"Algeria",away:"Austria"},
      {id:"G72",date:"Jun 28",home:"Jordan",away:"Argentina"},
    ];
  ...
  function myTotal(){return ALL_MATCHES.reduce((s,m)=>s+calcScore(predictions[m.id]||{},actuals[m.id]||{}),0);}
